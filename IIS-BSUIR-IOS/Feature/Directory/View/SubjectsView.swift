...
struct SubjectsView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("directory.subjects.title".localized())
        ...
        VStack(spacing: Constants.Layout.pickerSpacing) {
            ...
            SubjectPickerView(
                ...
                selectedLabel: viewModel.selectedSemester.map {
                    String(format: "subjects.picker.semester_value %lld".localized(), $0)
                },
                isLoading: false,
        ...
        List {
            if !viewModel.disciplines.isEmpty {
                ...
                ContentUnavailableView {
                    Label("subjects.empty.title".localized(), systemImage: Constants.Icons.empty)
                }
                    .listRowBackground(Color.clear)
                    .listRowSeparator(.hidden)
            }
